            ...
            <div id="updateRoomContainer">
                ...
                <div id="updateRightSide">
                    <TextField
                        ...
                        variant="standard"
                        type="text"
                            onChange={(e) => setTheNewUser({ ...theNewUser, firstName: e.target.value })}
                    ...
                    <div id="updateLeftSide">
                        ...
                        <Select
                            ...
                            label="Role"
                            onChange={(e) => setTheNewUser({ ...theNewUser, role: e.target.value })}
                        >
                ...
                <button id="updateRoomButton" onClick={updateTheUserFunc}>Update</button>
            </div>
