...
function DeleteRoom({ state, setState, roomToDelete }) {
    ...
    return state ? (
        <div id="deleteRoom" >
            <div id="DeleteRoomContainer">
                ...
                <div id="message"> <b>Are you sure you want to delete this room? This action can't be changed</b></div>
                <button id="deleteRoomButton" onClick={deleteTheRoomFunc}>Delete</button>
            </div>
