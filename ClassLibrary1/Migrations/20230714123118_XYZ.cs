        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Room__companyId__49C3F6B7",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true),
                    password = table.Column<string>(type: "char(1)", unicode: false, fixedLength: true, maxLength: 1, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__User__companyId__4E88ABD4",
                        column: x => x.companyId,
                        principalTable: "Company",
                        principalColumn: "companyId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    meetingStatus = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Reservati__roomI__4CA06362",
                        column: x => x.roomId,
                        principalTable: "Room",
